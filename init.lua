...
vim.o.shell = '/bin/zsh'
vim.api.nvim_set_keymap('', '<leader>wq', '<cmd>q<cr>', { noremap = true })
vim.api.nvim_set_keymap('', '<leader>fs', '<ESC>:w<cr>', { noremap = true })
vim.api.nvim_set_keymap('', '<leader>gb', '<ESC>:Git blame<cr>', { noremap = true })
